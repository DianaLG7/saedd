...
<html lang="es">
    <head>
        ...
        <title>Inicio-Sesión_SAEDD</title>
         <!--
...
<main class="contenedor sombra">
    <section>
        ...
        <form action="config_login.php" class="formulario" method="POST">
            <fieldset>
                <legend>INGRESA TODOS LOS CAMPOS</legend>
                ...
                <div class="contenedor-campos">
                    ...
                    <div class="campo">
                        <div align="center">
                            <input class="input-text" type="number" placeholder="&#128187;" name="txtid" required>
                        </div>
                    </div>
                    ...
                    <div class="campo">
                        <div align="center">
                            <input class="input-text" type="password" placeholder="&#128274;"  name="txtpass" required>
                        </div>
                    </div>
            ...
            <div align="center">
                <input class="boton w-sm-100" type="submit" name="btningresar" value="Iniciar sesión" >
            </div>
