...
<html lang="es">
    <head>
        ...
        <script src="js/personalizadas.js" language="javascript" type="text/javascript"></script>
        <script>
...
<nav class="navbar navbar-expand-xl navbar-dark d-block d-xl-flex justify-content-center" id="menu-principal">
    <div class="u-noPaddingContainer">
        ...
        <div class="collapse navbar-collapse d-xl-flex justify-content-md-around" id="navbarSupportedContent">
			<ul class="navbar-nav">
        <li class="nav-item"> <a class="nav-link" href="index.php" title="Inicio">
            Inicio
            </a>
        </li>
        <li class="nav-item">
        <a class="nav-link" title="Convocatoria" href="convocatoria.html">
            Convocatoria
        </a>
        </li>
        <li class="nav-item">
        <a class="nav-link" title="Formatos" href="formatos.html">
            Formatos
        </a>
        </li>
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" title="Iniciar sesión o Registrarse" href="#" id="Dropdown11" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                Iniciar sesión o Registrarse
            </a>
            <ul class="dropdown-menu" aria-labelledby="Dropdown11">
                <li>
                    <a class="dropdown-item" href="login.php" title="Iniciar sesión" >
                        Iniciar sesión
                    </a>
                </li>
                <li>
                    <a class="dropdown-item" href="register.php" title="Registrarse" >
                        Registrarse
                    </a>
                </li>
            </ul>
        ...
        <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="Dropdown11">
                <li>
                    <a class="dropdown-item" href="https://www.ipn.mx/seacademica/conocenos/misionvision.html" title="Misión y Visión" >
                    Misión y Visión
                    </a>
                </li>
                <li>
                    <a class="dropdown-item" href="https://www.ipn.mx/seacademica/conocenos/semblanza.html" title="Semblanza del Titular" >
                    Semblanza del Titular
                    </a>
                </li>
                <li>
                    <a class="dropdown-item" href="https://www.ipn.mx/seacademica/conocenos/directorioseaca/" title="Directorio" >
                    Directorio
                    </a>
                </li>
                <li>
                    <a class="dropdown-item" href="https://www.ipn.mx/seacademica/conocenos/organigrama.pdf" title="Organigrama" >
                    Organigrama
                    </a>
                </li>
                <li>
                    <a class="dropdown-item" href="https://www.ipn.mx/normatividad/" title="Normatividad" >
                    Normatividad
                    </a>
                </li>
            </ul>
...
<main class="contenedor sombra">
    <section>
        <h2>Registro</h2>
        <form action="config_register.php" class="formulario" method="post" id="registro">
            <fieldset>
                ...
                <div class="campo">
                    <div align="center">
                        <input class="input-text" type="number" placeholder="&#128187;" name="txtid" id="idbecario" required>
                    </div>
                </div>

                <div class="campo">
                    <div align="center"><label>Contraseña:</label></div>
                </div>

                <div class="campo">
                    <div align="center">
                        <input class="input-text" type="password" placeholder="&#128274;"  name="txtpass1" id="pass1" required>
                    </div>
                </div>

                <div class="campo">
                    <div align="center"><label>Confirmar Contraseña:</label></div>
                </div>

                <div class="campo">
                    <div align="center">
                        <input class="input-text" type="password" placeholder="&#128274;"  name="txtpass2" id="pass2" required>
                    </div>
                </div>
                ...
                <div class="campo">
                    ...
                    <input class="input-text" type="text" placeholder="Unidad Académica" name="uacademica" required>
                </div>
                ...
                <div class="campo">
                    <label>Correo:</label>
                    <input class="input-text" type="email" placeholder="Correo personal">
                </div>

                <div class="campo">
                    <label>Correo alterno:</label>
                    <input class="input-text" type="email" placeholder="Correo alterno">
                </div>
                -->
                ...
                <div align="center">
                    <input class="boton w-sm-150" type="submit" value="Registrar" name="btnregistrar" onclick="ValidarRegistro()">
                </div>
            </fieldset>
        </form>
        <br><br><br>
