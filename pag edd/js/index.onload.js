	...
	$(document).ready(function(){
		...
		// Envia el foco a la opción del menu seleccionada
		...
		//  Configuración del carrusel de 6 elementos
        ...
        //  Configuración del carrusel de 1 elemento
		$('.owl-uno').owlCarousel({  		
	  		dots: false,
	  		loop:true,
	  		navText: [ '<span class="fa-stack" style="vertical-align: top;"><i class="fas fa-circle fa-stack-2x carrusel-circulo"></i><i class="fas fa-chevron-left fa-stack-1x fa-inverse carrusel-flecha"></i></span>' , '<span class="fa-stack" style="vertical-align: top;"><i class="fas fa-circle fa-stack-2x carrusel-circulo"></i><i class="fas fa-chevron-right fa-stack-1x fa-inverse carrusel-flecha"></i></span>' ],	    
	    ...
	    //  Configuración del carrusel de 4 elementos
	    ...
	    //  Configuración del carrusel de 3 elementos
	...
	$(window).scroll(function() {
		...
		if( $(this).scrollTop() > 179 ) {
			...
			// Muestra el botón para regresar arriba
    		...
    		/* Comprueba si existe el menu manual para ajustar la altura del margen y la posición de la franja del nombre de la escuea */
			...
			// Oculta el botón para regresar arriba
			$('#top-contenedor').slideUp('slow');

			/* Regresa el menu principal a su posición original */
			...
			/* Regresa el menu manual a su posición original */
			...
			/* Regresa el nombre de escuela a su posición original*/
	...
	// Resetear Aumentar el tamaño de la letra
...
// Funcion con relación de las ubicaciones
...
var selectInfo= 0; var url; var textoInfo = "";
	function cargarSelect(valor){
			...
			new Array(1,3,"Movilidad Académica: Nacional e Internacional"),
			new Array(1,4,"Convenios de Colaboración Académica"),
			new Array(1,5,"Bolsa de trabajo"),
			new Array(1,6,"Orientación juvenil"),
			new Array(1,7,"Gestión de trámites"),
			new Array(1,8,"Cambio de Modalidad escolarizada a Modalidad mixta"),
			new Array(1,9,"Seguimiento de trámite de título, certifiado, carta de pasante y cedula profesional"),
			new Array(1,10,"Otro"),
			new Array(2,1,"Proceso de admisión"),
			new Array(2,2,"Convocatorias"),
			new Array(2,3,"Educacion virtual"),
			new Array(2,4,"Dudas específicas"),
			...
			new Array(3,4,"Información relacionada a comunicados"),
			new Array(3,5,"Registro de empresas para proveedores"),
			new Array(3,6,"Otro"),
			new Array(4,1,"Movilidad Académica: Nacional e Internacional"),
			new Array(4,2,"Año sabático"),
			new Array(4,3,"Otro"),
			new Array(5,1,"Prestaciones y servicios capital humano"),
			new Array(5,2,"Trámites capital humano"),
			new Array(5,3,"Correo electrónico"),
			new Array(5,4,"Otro")
		);
		...
		{//Selector de opciones
			...
			//Alumnos
				switch (true) {
					...
					case (valor2 == 2):
					case (valor2 == 5):
						textoInfo = "Dirección de Egresados y Servicio Social";
						break;
					case (valor2 == 3):
					case (valor2 == 4):
					...
					case (valor2 == 7):
					case (valor2 == 8):
						textoInfo = "Dirección de Administración Escolar";
						break;
					case (valor2 == 6):
						textoInfo = "Dirección de Servicios Educativos";
						break;
					case (valor2 == 10):
						textoInfo = "Dirección del Portal Web Institucional";
						break;
					default:
						alert("Selecciona una opción");
						break;
			...
			{//Externos
				switch (true) {
					...
					case (valor2 == 4):
						...
						break;
					case (valor2 == 5):
						textoInfo = "Secretaría de Administración del IPN";
						break;
					case (valor2 == 6):
						textoInfo = "Dirección del Portal Web Institucional";
						break;
			...
			{//Docente
				switch (true) {
					case valor2==1:
						...
						break;
					case valor2==2:
						textoInfo = "Secretaría academica";
						break;
					case (valor2 == 3):
						textoInfo = "Dirección del Portal Web Institucional";
						break;
			...
			{//Servicios
				switch (true) {
					case valor2==1:
					case valor2==2:
						textoInfo = "Dirección de Capital Humano";
						break;
					case valor2==3:
						textoInfo = "Dirección de Cómputo y Comunicaciones";
						break;
					case (valor2 == 4):
						textoInfo = "Dirección del Portal Web Internacional";
						break;
					default:
						alert("Selecciona una opción");
						break;
		...
		switch (selectInfo) {
					...
					case 4:
						if(revisar(selectInfo))
							{
								alert("Su mensaje será enviado a la " +textoInfo +", Unidad Responsable encargada del servicio");
