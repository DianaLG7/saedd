...
<main class="contenedor sombra">
    <section>
        <form action="mail_password.php" class="formulario" method="POST">
            <fieldset>
                <legend>RESTABLECE TU CONTRASEÑA</legend>

                <div class="contenedor-campos">

                    <div class="campo">
                        <div align="center"><label>Ingresa tu correo electrónico asociado a tu cuenta del EDD:</label></div>
                    </div>

                    <div class="campo">
                        <div align="center">
                            <input class="input-text" type="text" placeholder="&#x1f4e7;" name="txtemail" required>
                        </div>
                    </div>
            ...
            <div align="center">
                <input class="boton w-sm-100" type="submit" name="btnenviar" value="Enviar correo" >
            </div>
